 ...
 *       &lt;group ref="{}par-content" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;attGroup ref="{}par-attlist"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class Par {
    ...
    protected List<JAXBElement<?>> parContent;
    ...
    /**
     * Gets the value of the parContent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the parContent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getParContent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getParContent() {
        if (parContent == null) {
            parContent = new ArrayList<JAXBElement<?>>();
        }
        return this.parContent;
    }

    /**
     * Ruft den Wert der endsync-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Legt den Wert der endsync-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
