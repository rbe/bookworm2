...
public final class ShardStartServicingEvent implements Serializable {

    private final ZonedDateTime occurdOn;

    private final String shardName;

    public ShardStartServicingEvent(final String shardName) {
    ...
    public boolean equals(final Object o) {
        ...
        final ShardStartServicingEvent that = (ShardStartServicingEvent) o;
