...
public final class ShardStopServicingEvent implements Serializable {

    private final ZonedDateTime occurdOn;

    private final String shardName;

    public ShardStopServicingEvent(final String shardName) {
    ...
    public boolean equals(final Object o) {
        ...
        final ShardStopServicingEvent that = (ShardStopServicingEvent) o;
