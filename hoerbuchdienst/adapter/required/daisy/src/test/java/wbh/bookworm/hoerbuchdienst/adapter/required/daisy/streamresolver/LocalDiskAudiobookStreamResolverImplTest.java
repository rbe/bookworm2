...
@MicronautTest
class LocalDiskAudiobookStreamResolverImplTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(LocalDiskAudiobookStreamResolverImplTest.class);
