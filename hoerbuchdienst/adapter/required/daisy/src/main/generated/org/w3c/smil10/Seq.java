 ...
 *       &lt;group ref="{}seq-content" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;attGroup ref="{}seq-attlist"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class Seq {
    ...
    protected List<JAXBElement<?>> seqContent;
    ...
    /**
     * Gets the value of the seqContent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the seqContent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSeqContent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getSeqContent() {
        if (seqContent == null) {
            seqContent = new ArrayList<JAXBElement<?>>();
        }
