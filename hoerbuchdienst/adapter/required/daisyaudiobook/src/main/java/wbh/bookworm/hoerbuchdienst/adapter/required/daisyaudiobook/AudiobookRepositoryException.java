...
public final class AudiobookRepositoryException extends RuntimeException {
    ...
    public AudiobookRepositoryException() {
    }
    ...
    public AudiobookRepositoryException(final Throwable cause) {
        super(cause);
    }

    public AudiobookRepositoryException(final String message, final Throwable cause, final boolean enableSuppression, final boolean writableStackTrace) {
