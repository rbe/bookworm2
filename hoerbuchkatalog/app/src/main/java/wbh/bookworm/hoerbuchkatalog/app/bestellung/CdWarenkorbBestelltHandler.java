...
@Component
public class CdWarenkorbBestelltHandler extends GlobalDomainEventSubscriber<CdWarenkorbBestellt> {

    public CdWarenkorbBestelltHandler() {
    ...
    public void handleEvent(final CdWarenkorbBestellt domainEvent) {
        logger.info("Hörer {} hat folgende CDs bestellt: {}",
                domainEvent.getHoerernummer(), domainEvent.getHoerernummer());
    }
