...
[plantuml,06_hoerbuch_bereitstellen.svg,svg]
----
include::06_hoerbuch_bereitstellen.puml[]
----

=== _<Bezeichnung Laufzeitszenario 2>_

[plantuml,06_hoerbuch_als_download_bestellen.svg,svg]
----
include::06_hoerbuch_als_download_bestellen.puml[]
----
