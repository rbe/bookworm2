...
image:images/05_building_blocks-DE.png["Baustein Sichten"]
...
[plantuml,05_level1.svg,svg]
----
include::05_wbhonline_blackbox.puml[]
----
...
include::05_hoerbuchkatalog.adoc[leveloffset=+1]
include::05_hoerbuchdienst.adoc[leveloffset=+1]
