...
[plantuml,01_akteure,svg]
----
include::01_akteure.puml[]
----

* Anbieter, eine Hörbücherei
* Nutzer, ein:e Hörer:in
* Entwicklung, ein Architekt, Entwickler und Administrator

Geschäftsziele:

* Die Hörbücherei möchte ihren Hörern Hörbücher zum Download anbieten
* Die Hörbücherei möchte ihren Hörern Hörproben anbieten
* Die Hörbücherei möchte ihren Hörern Hörbücher als CD anbieten
